...
root_dir      = os.getcwd() # temporary
root_dir      = '/datasets/WIDER_FACE'
...
default_num_neg = 50
default_num_pos = 20  # pos and part
print_freq      = 100
...
for annotation in annotations:
    ...
    ##- debug
    #for label in boxes: # x1, x2, y1, y2
    #    #cv2.rectangle(img, (label[0], label[1]), (label[0]+label[2], label[1]+label[3]), (0,0,255), 
    #    cv2.rectangle(img, (label[0], label[1]), (label[2], label[3]), (0,0,255), 3)
    #    cv2.imshow("test", img)
