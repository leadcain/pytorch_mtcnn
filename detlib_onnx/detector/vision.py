...
def easy_vis(img, bboxes, lmks, scale=(1,1),  threshold=0.9, save_path=None):
    ...
    if lmks is not None:
        ...
        for lmk in lmks:
            cv2.circle(img, (lmk[0,0], lmk[0,1]), radius=3, thickness=2, color=(255, 255, 0))
            cv2.circle(img, (lmk[1,0], lmk[1,1]), radius=3, thickness=2, color=(255, 255, 0))
            cv2.circle(img, (lmk[2,0], lmk[2,1]), radius=3, thickness=2, color=(255, 255, 0))
            cv2.circle(img, (lmk[3,0], lmk[3,1]), radius=3, thickness=2, color=(255, 255, 0))
            cv2.circle(img, (lmk[4,0], lmk[4,1]), radius=3, thickness=2, color=(255, 255, 0))
            cv2.circle(img, (lmk[5,0], lmk[5,1]), radius=3, thickness=2, color=(255, 255, 0))
