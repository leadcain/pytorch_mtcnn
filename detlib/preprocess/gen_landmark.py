...
def gen_config():
    ...
    parser.add_argument('--root_dir',  type=str,  default='/datasets/WIDER_FACE2')
    parser.add_argument('--anno_file', type=str,  default='/datasets/WIDER_FACE2/face_landmark/TrainImageList_6Landmark.txt')
    parser.add_argument('--data_dir',  type=str,  default='/datasets/WIDER_FACE2/face_landmark')
    parser.add_argument('--save_dir',  type=str,  default='/datasets/WIDER_FACE2')
